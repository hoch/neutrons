...
ScratchPattern.BabyExample = new ScratchPattern()
    .appendScratch(d1d4, Scratches.baby, 0.5)
    .appendScratch(d1d4, Scratches.baby, 0.5)
    .appendScratch(d1d8, Scratches.baby, 0.5)
    .appendScratch(d3d8, Scratches.baby, 0.5)
;
...
ScratchPattern.TearExample = new ScratchPattern()
    .appendScratch(d1d4, Scratches.tearOut, 2, 0.5)
    .appendScratch(d1d4, Scratches.tearIn, 2, 0.5)
    .appendScratch(d1d8, Scratches.tearIn, 2, 0.5)
    .appendScratch(d3d8, Scratches.tearInOut, 2, 0.5)
    /*.appendFadePoint(d1d16, 1)
    .appendFadePoint(d1d16, 0)
    .appendFadePoint(d1d16, 1)
    .appendFadePoint(d1d16, 0)
...
ScratchPattern.ReleaseExample = new ScratchPattern()
    .appendScratch(0.25, Scratches.baby, 0.5)
    .appendScratch(0.25, Scratches.linear, 1.0)
    .appendScratch(0.25, Scratches.baby, 0.5)
    .appendScratch(0.25, Scratches.linear, 1.0)
    .appendFadePoint(d1d16, 0)
    .appendFadePoint(d1d16, 1)
